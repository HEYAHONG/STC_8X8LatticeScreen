...
S:Lmain.LS_595_DataOut$Row_Data$1_0$3({1}SC:U),R,0,0,[r7]
S:Lmain.LS_595_DataOut$i$1_0$4({1}SC:U),R,0,0,[r6]
S:Lmain.LS_DisplayOneRow$Col_Index$1_0$11({1}SC:U),E,0,0
...
S:Lmain.LS_Init$P1M1$1_0$1({1}SC:U),I,0,0
S:Lmain.LS_Init$P1M0$1_0$1({1}SC:U),I,0,0
