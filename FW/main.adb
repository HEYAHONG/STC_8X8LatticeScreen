...
F:G$Uart_Timer2_Interrupt$0_0$0({2}DF,SV:S),C,0,0,1,12,0
...
F:G$Check_Echo_Rx_ON$0_0$0({2}DF,SV:S),C,0,0,0,0,0
...
S:Lmain.Uart_Send$data$1_0$57({1}SC:U),R,0,0,[r7]
S:Lmain.On_Uart_Idle$length$1_0$75({2}SI:U),E,0,0
S:Lmain.On_Uart_Idle$buff$1_0$75({1}DI,SC:U),R,0,0,[r1]
S:Lmain.On_Uart_Idle$address$2_0$84({2}SI:U),R,0,0,[r5,r4]
S:Lmain.On_Uart_Idle$i$2_0$89({1}SC:U),R,0,0,[r7]
S:Lmain.On_Uart_Idle$address$2_0$92({2}SI:U),R,0,0,[r5,r4]
S:Lmain.On_Uart_Idle$i$3_0$93({1}SC:U),R,0,0,[r7]
S:Lmain.On_Uart_Buff_Full$length$1_0$96({2}SI:U),E,0,0
S:Lmain.On_Uart_Buff_Full$buff$1_0$96({1}DI,SC:U),R,0,0,[]
...
S:G$Echo_Rx_On_Flag$0_0$0({1}SB0$1:U),H,0,0
...
S:Lmain.Uart_Init$AUXR$1_0$53({1}SC:U),I,0,0
S:Lmain.Uart_Init$T2H$1_0$53({1}SC:U),I,0,0
S:Lmain.Uart_Init$T2L$1_0$53({1}SC:U),I,0,0
S:Lmain.Uart_Init$P_SW1$1_0$53({1}SC:U),I,0,0
S:Lmain.Uart_Init$IE2$1_0$53({1}SC:U),I,0,0
S:Lmain.Clk_In_Init$P3M1$1_0$71({1}SC:U),I,0,0
S:Lmain.Clk_In_Init$P3M0$1_0$71({1}SC:U),I,0,0
...
S:G$Uart_Timer2_Interrupt$0_0$0({2}DF,SV:S),C,0,0
...
S:G$Check_Echo_Rx_ON$0_0$0({2}DF,SV:S),C,0,0
