...
S:Lmain.On_Uart_Idle$length$1_0$76({2}SI:U),E,0,0
S:Lmain.On_Uart_Idle$buff$1_0$76({1}DI,SC:U),R,0,0,[r1]
S:Lmain.On_Uart_Idle$address$2_0$85({2}SI:U),R,0,0,[r5,r4]
S:Lmain.On_Uart_Idle$i$2_0$90({1}SC:U),R,0,0,[r7]
S:Lmain.On_Uart_Idle$address$2_0$93({2}SI:U),R,0,0,[r5,r4]
S:Lmain.On_Uart_Idle$i$3_0$94({1}SC:U),R,0,0,[r7]
S:Lmain.On_Uart_Buff_Full$length$1_0$97({2}SI:U),E,0,0
S:Lmain.On_Uart_Buff_Full$buff$1_0$97({1}DI,SC:U),R,0,0,[]
