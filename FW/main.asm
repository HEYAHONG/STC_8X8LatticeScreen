...
Lmain.Uart_Init$AUXR$1_0$53 == 0x008e
_Uart_Init_AUXR_65536_53	=	0x008e
Lmain.Uart_Init$T2H$1_0$53 == 0x00d6
_Uart_Init_T2H_65536_53	=	0x00d6
Lmain.Uart_Init$T2L$1_0$53 == 0x00d7
_Uart_Init_T2L_65536_53	=	0x00d7
Lmain.Uart_Init$P_SW1$1_0$53 == 0x00a2
_Uart_Init_P_SW1_65536_53	=	0x00a2
Lmain.Uart_Init$IE2$1_0$53 == 0x00af
_Uart_Init_IE2_65536_53	=	0x00af
Lmain.Clk_In_Init$P3M1$1_0$71 == 0x00b1
_Clk_In_Init_P3M1_65536_71	=	0x00b1
Lmain.Clk_In_Init$P3M0$1_0$71 == 0x00b2
_Clk_In_Init_P3M0_65536_71	=	0x00b2
;--------------------------------------------------------
...
_LS_DisplayOneCol_PARM_2:
	.ds 1
Lmain.On_Uart_Idle$length$1_0$76==.
_On_Uart_Idle_PARM_2:
	.ds 2
Lmain.On_Uart_Buff_Full$length$1_0$97==.
...
;	main.c:24: __idata uint64_t systick=0;//系统主时间，由Timer0驱动，需要链接liblonglong.lib,否则无法链接成功
	...
	inc	r0
	mov	@r0,a
	C$main.c$152$1_0$103 ==.
;	main.c:152: __idata uint8_t Uart_Receive_Buff[64],Uart_Receive_Buff_Index=0,Uart_Echo_To_Send=0;
	mov	r0,#_Uart_Receive_Buff_Index
	mov	@r0,#0x00
	C$main.c$152$1_0$103 ==.
;	main.c:152: __idata int8_t Receive_Timeout_Tick=2;
	mov	r0,#_Uart_Echo_To_Send
	mov	@r0,#0x00
	C$main.c$153$1_0$103 ==.
;	main.c:153: void On_Uart_Buff_Full(uint8_t  __idata * buff,size_t length);
	mov	r0,#_Receive_Timeout_Tick
	mov	@r0,#0x02
	C$main.c$258$1_0$103 ==.
;	main.c:258: uint16_t __idata Device_Address=0;//默认地址 
	mov	r0,#_Device_Address
	mov	@r0,a
	inc	r0
	mov	@r0,a
	C$main.c$67$1_0$103 ==.
;	main.c:67: __bit Tx_Busy=0;//串口发送忙标志
;	assignBit
	clr	_Tx_Busy
	C$main.c$69$1_0$103 ==.
;	main.c:69: __bit Echo_Data=0;//是否有回送的数据
;	assignBit
	clr	_Echo_Data
	C$main.c$112$1_0$103 ==.
;	main.c:112: extern __bit Echo_Rx;
;	assignBit
	setb	_Echo_Rx
	C$main.c$259$1_0$103 ==.
;	main.c:259: __bit     Device_Address_Set_Flag=0;//设置标志，发送本机地址的下一个地址
;	assignBit
	clr	_Device_Address_Set_Flag
	C$main.c$260$1_0$103 ==.
;	main.c:260: __bit	  Echo_Rx_On_Flag=0;//打开回显标志，回显由关变为开时为1.
;	assignBit
...
;------------------------------------------------------------
	...
	C$main.c$46$1_1$52 ==.
;	main.c:46: void systick_interrupt() __interrupt (1) __using (1) 
;	-----------------------------------------
...
;------------------------------------------------------------
;AUXR                      Allocated with name '_Uart_Init_AUXR_65536_53'
;T2H                       Allocated with name '_Uart_Init_T2H_65536_53'
;T2L                       Allocated with name '_Uart_Init_T2L_65536_53'
;P_SW1                     Allocated with name '_Uart_Init_P_SW1_65536_53'
;IE2                       Allocated with name '_Uart_Init_IE2_65536_53'
;------------------------------------------------------------
	G$Uart_Init$0$0 ==.
	C$main.c$70$1_0$53 ==.
;	main.c:70: void Uart_Init()
;	-----------------------------------------
;	 function Uart_Init
;	-----------------------------------------
_Uart_Init:
	...
	C$main.c$77$1_0$53 ==.
;	main.c:77: ACC = P_SW1;
	mov	_ACC,_Uart_Init_P_SW1_65536_53
	C$main.c$78$1_0$53 ==.
;	main.c:78: ACC &= ~(S1_S0 | S1_S1);    //S1_S0=0 S1_S1=0
	anl	_ACC,#0x3f
	C$main.c$79$1_0$53 ==.
;	main.c:79: P_SW1 = ACC;                //(P3.0/RxD, P3.1/TxD)
	mov	_Uart_Init_P_SW1_65536_53,_ACC
	C$main.c$91$1_0$53 ==.
;	main.c:91: SCON = 0x50;                //8位可变波特率
	mov	_SCON,#0x50
	C$main.c$98$1_0$53 ==.
;	main.c:98: T2L = (65536 - (FOSC/4/BAUD)) & 0xff;   //设置波特率重装值
	mov	_Uart_Init_T2L_65536_53,#0xb8
	C$main.c$99$1_0$53 ==.
;	main.c:99: T2H = (65536 - (FOSC/4/BAUD))>>8;
	mov	_Uart_Init_T2H_65536_53,#0xff
	C$main.c$100$1_0$53 ==.
;	main.c:100: AUXR |= 0x14;                //T2为1T模式, 并启动定时器2
	orl	_Uart_Init_AUXR_65536_53,#0x14
	C$main.c$101$1_0$53 ==.
;	main.c:101: AUXR |= 0x01;               //选择定时器2为串口1的波特率发生器
	orl	_Uart_Init_AUXR_65536_53,#0x01
	C$main.c$102$1_0$53 ==.
;	main.c:102: ES = 1;                     //使能串口1中断
;	assignBit
	setb	_ES
	C$main.c$104$1_0$53 ==.
;	main.c:104: IE2 |= 0x04;//启动定时器2中断
	orl	_Uart_Init_IE2_65536_53,#0x04
	C$main.c$106$1_0$53 ==.
;	main.c:106: EA = 1;
;	assignBit
	setb	_EA
...
;	main.c:107: }
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Uart_Timer2_Interrupt'
;------------------------------------------------------------
	G$Uart_Timer2_Interrupt$0$0 ==.
	C$main.c$114$1_0$54 ==.
;	main.c:114: void Uart_Timer2_Interrupt() __interrupt (12) //定时器2(串口时钟源)中断
;	-----------------------------------------
;	 function Uart_Timer2_Interrupt
;	-----------------------------------------
_Uart_Timer2_Interrupt:
	push	bits
	push	acc
	push	b
	push	dpl
	...
	mov	psw,#0x00
	C$main.c$116$1_0$54 ==.
;	main.c:116: if(Uart_Receive_Buff_Index!=0)
	mov	r0,#_Uart_Receive_Buff_Index
	mov	a,@r0
	jz	00109$
	C$main.c$118$2_0$55 ==.
;	main.c:118: Receive_Timeout_Tick--;
	mov	r0,#_Receive_Timeout_Tick
	dec	@r0
	C$main.c$119$2_0$55 ==.
;	main.c:119: if(!Echo_Rx || (Echo_Rx && Uart_Receive_Buff_Index<=Uart_Echo_To_Send))//当未回送完成时，不检查串口空闲
	jnb	_Echo_Rx,00103$
	jnb	_Echo_Rx,00109$
	mov	r0,#_Uart_Receive_Buff_Index
...
00103$:
	C$main.c$120$2_0$55 ==.
;	main.c:120: if(Receive_Timeout_Tick<=0)
	mov	r0,#_Receive_Timeout_Tick
	clr	c
	mov	a,#(0x00 ^ 0x80)
	mov	b,@r0
	...
	jc	00109$
	C$main.c$122$3_0$56 ==.
;	main.c:122: On_Uart_Idle(Uart_Receive_Buff,Uart_Receive_Buff_Index);
	mov	r0,#_Uart_Receive_Buff_Index
	...
	lcall	_On_Uart_Idle
	C$main.c$123$3_0$56 ==.
;	main.c:123: Uart_Receive_Buff_Index=0;
	mov	r0,#_Uart_Receive_Buff_Index
	mov	@r0,#0x00
	C$main.c$124$3_0$56 ==.
;	main.c:124: Uart_Echo_To_Send=0;
	mov	r0,#_Uart_Echo_To_Send
	mov	@r0,#0x00
00109$:
	C$main.c$127$1_0$54 ==.
...
;------------------------------------------------------------
	G$Uart_Send$0$0 ==.
	C$main.c$129$1_0$58 ==.
;	main.c:129: void Uart_Send(uint8_t data)
;	-----------------------------------------
;	 function Uart_Send
;	-----------------------------------------
_Uart_Send:
	mov	r7,dpl
	C$main.c$131$1_0$58 ==.
;	main.c:131: while(Tx_Busy);//串口发送忙标志
00101$:
	jb	_Tx_Busy,00101$
	C$main.c$132$1_0$58 ==.
;	main.c:132: ACC = data;                  //获取校验位P (PSW.0)
	mov	_ACC,r7
	C$main.c$133$1_0$58 ==.
;	main.c:133: if (P)                      //根据P来设置校验位
	mov	c,_P
	C$main.c$149$1_0$58 ==.
;	main.c:149: Tx_Busy = 1;
;	assignBit
	setb	_Tx_Busy
	C$main.c$150$1_0$58 ==.
;	main.c:150: SBUF = ACC;                 //写数据到UART数据寄存器	
	mov	_SBUF,_ACC
	C$main.c$151$1_0$58 ==.
;	main.c:151: }
	C$main.c$151$1_0$58 ==.
...
;------------------------------------------------------------
	...
	C$main.c$155$1_0$62 ==.
;	main.c:155: void Uart_Interrupt() __interrupt(4)
;	-----------------------------------------
...
;	main.c:162: if(RI)
	jnb	_RI,00109$
	C$main.c$177$2_0$64 ==.
;	main.c:177: Uart_Receive_Buff[Uart_Receive_Buff_Index++]=SBUF;
	mov	r0,#_Uart_Receive_Buff_Index
	mov	ar7,@r0
	mov	r0,#_Uart_Receive_Buff_Index
	mov	a,r7
	...
	mov	@r0,_SBUF
	C$main.c$178$2_0$64 ==.
;	main.c:178: if(Echo_Rx)
	jnb	_Echo_Rx,00104$
	C$main.c$180$3_0$65 ==.
;	main.c:180: Echo_Data=1;
;	assignBit
	setb	_Echo_Data
00104$:
	C$main.c$182$2_0$64 ==.
;	main.c:182: if(Uart_Receive_Buff_Index>=sizeof(Uart_Receive_Buff))
	mov	r0,#_Uart_Receive_Buff_Index
	cjne	@r0,#0x40,00130$
00130$:
	jc	00106$
	C$main.c$184$3_0$66 ==.
;	main.c:184: On_Uart_Buff_Full(Uart_Receive_Buff,sizeof(Uart_Receive_Buff));
	mov	_On_Uart_Buff_Full_PARM_2,#0x40
	mov	(_On_Uart_Buff_Full_PARM_2 + 1),#0x00
	mov	dpl,#_Uart_Receive_Buff
	lcall	_On_Uart_Buff_Full
	C$main.c$185$3_0$66 ==.
;	main.c:185: Uart_Receive_Buff_Index=0;
	mov	r0,#_Uart_Receive_Buff_Index
	mov	@r0,#0x00
	C$main.c$186$3_0$66 ==.
;	main.c:186: Uart_Echo_To_Send=0;
	mov	r0,#_Uart_Echo_To_Send
	mov	@r0,#0x00
00106$:
	C$main.c$188$2_0$64 ==.
;	main.c:188: Receive_Timeout_Tick=48;
	mov	r0,#_Receive_Timeout_Tick
	mov	@r0,#0x30
	C$main.c$189$2_0$64 ==.
;	main.c:189: RI=0;
...
;------------------------------------------------------------
	...
	C$main.c$194$1_0$67 ==.
;	main.c:194: void Check_Uart_Echo()//检查回送数据
;	-----------------------------------------
;	 function Check_Uart_Echo
;	-----------------------------------------
_Check_Uart_Echo:
	C$main.c$196$1_0$67 ==.
;	main.c:196: if(Echo_Rx)
	jnb	_Echo_Rx,00109$
	C$main.c$198$2_0$68 ==.
;	main.c:198: if(Echo_Data)
	jnb	_Echo_Data,00110$
	C$main.c$201$3_0$69 ==.
;	main.c:201: while(Uart_Echo_To_Send < Uart_Receive_Buff_Index) 
00101$:
	mov	r0,#_Uart_Echo_To_Send
	...
	jnc	00103$
	C$main.c$202$3_0$69 ==.
;	main.c:202: Uart_Send(Uart_Receive_Buff[Uart_Echo_To_Send++]);
	mov	r0,#_Uart_Echo_To_Send
	mov	ar7,@r0
	mov	r0,#_Uart_Echo_To_Send
	mov	a,r7
...
00103$:
	C$main.c$204$3_0$69 ==.
;	main.c:204: if(Uart_Echo_To_Send>Uart_Receive_Buff_Index)
	mov	r0,#_Uart_Echo_To_Send
	mov	r1,#_Uart_Receive_Buff_Index
	clr	c
	mov	a,@r1
	...
	jnc	00110$
	C$main.c$205$3_0$69 ==.
;	main.c:205: Uart_Echo_To_Send=0;
	mov	r0,#_Uart_Echo_To_Send
	mov	@r0,#0x00
	sjmp	00110$
00109$:
	C$main.c$210$2_0$70 ==.
;	main.c:210: Uart_Echo_To_Send=Uart_Receive_Buff_Index;
	mov	r0,#_Uart_Receive_Buff_Index
	mov	a,@r0
	mov	r0,#_Uart_Echo_To_Send
	mov	@r0,a
...
;------------------------------------------------------------
;P3M1                      Allocated with name '_Clk_In_Init_P3M1_65536_71'
;P3M0                      Allocated with name '_Clk_In_Init_P3M0_65536_71'
;------------------------------------------------------------
	G$Clk_In_Init$0$0 ==.
	C$main.c$216$1_0$71 ==.
;	main.c:216: void Clk_In_Init()
;	-----------------------------------------
...
_Clk_In_Init:
	C$main.c$221$1_0$71 ==.
;	main.c:221: P3M1&=~(1<<2);
	anl	_Clk_In_Init_P3M1_65536_71,#0xfb
	C$main.c$222$1_0$71 ==.
;	main.c:222: P3M0&=~(1<<2);
	anl	_Clk_In_Init_P3M0_65536_71,#0xfb
	C$main.c$224$1_0$71 ==.
;	main.c:224: P3_2=1;//准双向口输出高电平
;	assignBit
	setb	_P3_2
	C$main.c$226$1_0$71 ==.
;	main.c:226: INT0 = 1;
;	assignBit
	setb	_INT0
	C$main.c$227$1_0$71 ==.
;	main.c:227: IT0 = 0;                    //设置INT0的中断类型 (1:仅下降沿 0:上升沿和下降沿)
;	assignBit
	clr	_IT0
	C$main.c$228$1_0$71 ==.
;	main.c:228: EX0 = 1;                    //使能INT0中断
;	assignBit
	setb	_EX0
	C$main.c$229$1_0$71 ==.
;	main.c:229: EA = 1;
...
;------------------------------------------------------------
	...
	C$main.c$233$1_0$72 ==.
;	main.c:233: void Clk_In_Interrupt() __interrupt (0)
;	-----------------------------------------
...
_Clk_In_Interrupt:
	...
	mov	psw,#0x00
	C$main.c$235$1_0$72 ==.
;	main.c:235: if(TR0)//当T0作为系统主时间时，停止T0,重置系统主时间
	C$main.c$237$2_0$73 ==.
;	main.c:237: TR0=0;//关闭定时器0
;	assignBit
	jbc	_TR0,00109$
	sjmp	00102$
00109$:
	C$main.c$238$2_0$73 ==.
;	main.c:238: ET0=0;//关闭定时器0中断
;	assignBit
	clr	_ET0
	C$main.c$239$2_0$73 ==.
;	main.c:239: systick=0;//清零系统主时间
	mov	r0,#_systick
	clr	a
	mov	@r0,a
	inc	r0
...
00110$:
	C$main.c$245$2_0$74 ==.
;	main.c:245: P3_3=!P3_3;
	cpl	_P3_3
	C$main.c$247$2_0$74 ==.
;	main.c:247: On_SysTick_Timer();
	lcall	_On_SysTick_Timer
	C$main.c$249$2_0$72 ==.
;	main.c:249: }
	pop	psw
...
;------------------------------------------------------------
	...
	C$main.c$253$2_0$75 ==.
;	main.c:253: void On_SysTick_Timer()//系统的毫秒级定时器
;	-----------------------------------------
;	 function On_SysTick_Timer
;	-----------------------------------------
_On_SysTick_Timer:
	C$main.c$255$1_0$75 ==.
;	main.c:255: LS_Refresh();//刷新点阵屏	
	lcall	_LS_Refresh
	C$main.c$256$1_0$75 ==.
;	main.c:256: }
	C$main.c$256$1_0$75 ==.
...
;------------------------------------------------------------
	G$On_Uart_Idle$0$0 ==.
	C$main.c$262$1_0$77 ==.
;	main.c:262: void On_Uart_Idle(uint8_t __idata * buff,size_t length)//串口空闲的函数
;	-----------------------------------------
...
_On_Uart_Idle:
	mov	r1,dpl
	C$main.c$264$1_0$77 ==.
;	main.c:264: if(length==1)//当长度为1时，是可显示字符就显示此字符
	mov	a,#0x01
...
00218$:
	C$main.c$266$2_0$78 ==.
;	main.c:266: if(buff[0]>=0x20 && buff[0]<0x80)
	mov	ar7,@r1
	cjne	r7,#0x20,00219$
00219$:
	jc	00102$
...
00221$:
	jnc	00102$
	C$main.c$268$3_0$79 ==.
;	main.c:268: LS_Show_Char_Font5x7(buff[0]);	
	mov	dpl,r7
	push	ar1
...
00102$:
	C$main.c$271$2_0$78 ==.
;	main.c:271: if(buff[0]==0xff)//开启串口回送
	mov	ar7,@r1
	cjne	r7,#0xff,00107$
	C$main.c$273$3_0$80 ==.
;	main.c:273: if(!Echo_Rx)//当处于关闭回显状态时
	jb	_Echo_Rx,00105$
	C$main.c$275$4_0$81 ==.
;	main.c:275: Echo_Rx_On_Flag=1;
;	assignBit
	setb	_Echo_Rx_On_Flag
00105$:
	C$main.c$277$3_0$80 ==.
;	main.c:277: Echo_Rx=1;
;	assignBit
	setb	_Echo_Rx
00107$:
	C$main.c$279$2_0$78 ==.
;	main.c:279: if(buff[0]==0x00)//关闭串口回送
	mov	a,r7
	jnz	00111$
	C$main.c$281$3_0$82 ==.
;	main.c:281: Echo_Rx=0;
;	assignBit
	clr	_Echo_Rx
00111$:
	C$main.c$284$1_0$77 ==.
;	main.c:284: if(length==2)//当长度为2时表明这是一个地址设置包，包内含有当前地址（16位）
	mov	a,#0x02
...
00228$:
	C$main.c$286$2_0$83 ==.
;	main.c:286: if(!Echo_Rx)//关闭回送时才能设置地址
	jb	_Echo_Rx,00115$
	C$main.c$288$3_0$84 ==.
;	main.c:288: Device_Address_Set_Flag=1;
;	assignBit
	setb	_Device_Address_Set_Flag
	C$main.c$289$3_0$84 ==.
;	main.c:289: Device_Address=buff[1];
	mov	a,r1
	inc	a
	mov	r0,a
	mov	ar7,@r0
	C$main.c$290$3_0$84 ==.
;	main.c:290: Device_Address*=256;
	mov	ar6,r7
	mov	r7,#0x00
	C$main.c$291$3_0$84 ==.
;	main.c:291: Device_Address+=buff[0];
	mov	ar5,@r1
	mov	r4,#0x00
	mov	a,r5
	add	a,r7
...
00115$:
	C$main.c$294$1_0$77 ==.
;	main.c:294: if(length==3)//长度为3时,表示这是对某一个地址的进行字符设置,参考长度为1时的情况
	mov	a,#0x03
...
00231$:
	C$main.c$296$2_0$85 ==.
;	main.c:296: uint16_t address=buff[0]+(uint16_t)256*buff[1];
	mov	ar7,@r1
	mov	r6,#0x00
	mov	a,r1
	inc	a
	...
	mov	r4,a
	C$main.c$297$2_0$85 ==.
;	main.c:297: if(address==Device_Address)//是本模块的设置包
	mov	r0,#_Device_Address
	mov	a,@r0
	cjne	a,ar5,00232$
	inc	r0
...
00233$:
	C$main.c$299$3_0$86 ==.
;	main.c:299: if(buff[2]>=0x20 && buff[2]<0x80)
	mov	a,#0x02
	add	a,r1
	mov	r0,a
	mov	ar7,@r0
...
00236$:
	jnc	00117$
	C$main.c$301$4_0$87 ==.
;	main.c:301: LS_Show_Char_Font5x7(buff[2]);	
	mov	dpl,r7
	push	ar1
	push	ar0
	lcall	_LS_Show_Char_Font5x7
...
00117$:
	C$main.c$304$3_0$86 ==.
;	main.c:304: if(buff[2]==0xff)//开启串口回送
	mov	ar7,@r0
	cjne	r7,#0xff,00120$
	C$main.c$306$4_0$88 ==.
;	main.c:306: Echo_Rx=1;
;	assignBit
	setb	_Echo_Rx
00120$:
	C$main.c$308$3_0$86 ==.
;	main.c:308: if(buff[2]==0x00)//关闭串口回送
	mov	a,r7
	jnz	00126$
	C$main.c$310$4_0$89 ==.
;	main.c:310: Echo_Rx=0;
;	assignBit
	clr	_Echo_Rx
00126$:
	C$main.c$315$1_0$77 ==.
;	main.c:315: if(length==8)//当长度为8时,直接复制数据到8X8点阵显示内存
	mov	a,#0x08
...
00242$:
	C$main.c$318$3_0$91 ==.
;	main.c:318: for(i=0;i<8;i++)
	mov	r7,#0x00
00135$:
	C$main.c$320$4_0$92 ==.
;	main.c:320: LS_RAM[i]=buff[i];
	mov	a,r7
	add	a,#_LS_RAM
	mov	r0,a
	mov	a,r7
...
00129$:
	C$main.c$324$1_0$77 ==.
;	main.c:324: if(length==10)//当长度为10时，根据地址设置显示内容，参考长度为8时的效果
	mov	a,#0x0a
...
00246$:
	C$main.c$326$2_0$93 ==.
;	main.c:326: uint16_t address=buff[0]+(uint16_t)256*buff[1];
	mov	ar7,@r1
	mov	r6,#0x00
	mov	a,r1
	inc	a
	...
	mov	r4,a
	C$main.c$327$2_0$93 ==.
;	main.c:327: if(address==Device_Address)//是本模块的设置包
	mov	r0,#_Device_Address
	mov	a,@r0
	cjne	a,ar5,00247$
	inc	r0
...
00248$:
	C$main.c$330$4_0$95 ==.
;	main.c:330: for(i=0;i<8;i++)
	mov	r7,#0x00
00137$:
	C$main.c$332$5_0$96 ==.
;	main.c:332: LS_RAM[i]=buff[i+2];
	mov	a,r7
	add	a,#_LS_RAM
	mov	r0,a
	mov	ar5,r7
...
;------------------------------------------------------------
	...
	C$main.c$338$1_0$98 ==.
;	main.c:338: void On_Uart_Buff_Full(uint8_t __idata * buff,size_t length)//串口缓冲满
;	-----------------------------------------
;	 function On_Uart_Buff_Full
;	-----------------------------------------
_On_Uart_Buff_Full:
	C$main.c$341$1_0$98 ==.
;	main.c:341: UNUSED(length);
	C$main.c$343$1_0$98 ==.
;	main.c:343: }
	C$main.c$343$1_0$98 ==.
...
;------------------------------------------------------------
	...
	C$main.c$345$1_0$99 ==.
;	main.c:345: void Check_Device_Address_Set()
;	-----------------------------------------
;	 function Check_Device_Address_Set
;	-----------------------------------------
_Check_Device_Address_Set:
	C$main.c$347$1_0$99 ==.
;	main.c:347: if(Device_Address_Set_Flag)
	jnb	_Device_Address_Set_Flag,00103$
	C$main.c$350$2_0$100 ==.
;	main.c:350: Uart_Send(Device_Address+1);
	mov	r0,#_Device_Address
	mov	a,@r0
	inc	a
	mov	dpl,a
	lcall	_Uart_Send
	C$main.c$351$2_0$100 ==.
;	main.c:351: Uart_Send((Device_Address+1)>>8);
	mov	r0,#_Device_Address
	mov	a,#0x01
	add	a,@r0
	clr	a
	...
	mov	dpl,a
	lcall	_Uart_Send
	C$main.c$352$2_0$100 ==.
;	main.c:352: Device_Address_Set_Flag=0;
;	assignBit
	clr	_Device_Address_Set_Flag
00103$:
	C$main.c$354$1_0$99 ==.
...
;	main.c:356: void Check_Echo_Rx_ON()//检查回显
;	-----------------------------------------
;	 function Check_Echo_Rx_ON
;	-----------------------------------------
_Check_Echo_Rx_ON:
	C$main.c$358$1_0$101 ==.
;	main.c:358: if(Echo_Rx_On_Flag)
	jnb	_Echo_Rx_On_Flag,00103$
	C$main.c$360$2_0$102 ==.
;	main.c:360: Uart_Send(0xff);//发送打开回显命令
	mov	dpl,#0xff
	lcall	_Uart_Send
	C$main.c$361$2_0$102 ==.
;	main.c:361: Echo_Rx_On_Flag=0;
;	assignBit
	clr	_Echo_Rx_On_Flag
00103$:
	C$main.c$363$1_0$101 ==.
;	main.c:363: }
	C$main.c$363$1_0$101 ==.
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$main.c$365$1_0$103 ==.
;	main.c:365: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$main.c$367$1_0$103 ==.
;	main.c:367: systick_init();//初始化主时间
	lcall	_systick_init
	C$main.c$368$1_0$103 ==.
;	main.c:368: Clk_In_Init();//初始化外部中断
	lcall	_Clk_In_Init
	C$main.c$369$1_0$103 ==.
;	main.c:369: Uart_Init();//初始化串口
	lcall	_Uart_Init
	C$main.c$370$1_0$103 ==.
;	main.c:370: LS_Init();//初始化点阵屏
	lcall	_LS_Init
	C$main.c$372$1_0$103 ==.
;	main.c:372: while(1)
00102$:
	C$main.c$374$2_0$104 ==.
;	main.c:374: Check_Uart_Echo();//检查回送数据
	lcall	_Check_Uart_Echo
	C$main.c$375$2_0$104 ==.
;	main.c:375: Check_Device_Address_Set();//检查地址设置包
	lcall	_Check_Device_Address_Set
	C$main.c$376$2_0$104 ==.
;	main.c:376: Check_Echo_Rx_ON();//检查回显打开状态
	lcall	_Check_Echo_Rx_ON
	sjmp	00102$
	C$main.c$393$1_0$103 ==.
;	main.c:393: }
	C$main.c$393$1_0$103 ==.
	XG$main$0$0 ==.
	ret
